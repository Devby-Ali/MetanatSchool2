      ...
      <div className="container">
        <div className="flex flex-col lg:flex-row text-darkColor dark:text-white mb-12 lg:mb-28 gap-x-6">
          <div className="relative flex-center sm:my-10 lg:w-full">
            <div className="absolute w-[120%] 2xl:w-[160%] h-[120%] bg-light-blue-800 z-0 left-16 rounded-tl-[70px]"></div>
            <img
          ...
          <div className="space-y-6 mt-20 lg:w-full mr-4 text-darkBox dark:text-white/80">
            <h3 className="font-EstedadBold text-4xl xs:mt-8 md:text-5xl xl:text-6xl md:text-center">
              چرا متانت را انتخاب کنید؟
            </h3>
            <p className="text-md/relaxed lg:text-3xl/relaxed xl:text-4xl/relaxed">
            ...
            <ul className="child:flex child:items-center space-y-3 xs:space-y-2 child:lg:text-3xl child:xl:text-4xl">
              <li>
        ...
        <div className="grid grid-rows-2 md:grid-cols-2 gap-8 sm:gap-10 cursor-default">
          ...
          <AboutUsBox
            ...
            desc="به جرعت میتونم بگم سخت گیرترین شرایط جذب مدرس داریم چون برامون مهمه محتوا خیلی ساده و روان بیان بشه."
