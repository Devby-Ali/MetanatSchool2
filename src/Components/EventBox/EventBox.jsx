...
export default function EventBox({ id, img, title, desc, alt }) {
  return (
    <div className="blog h-[425px] flex flex-col bg-white dark:bg-darkBox text-darkColor dark:text-white overflow-hidden rounded-3xl">
      {/* <!-- Blog Banner --> */}
